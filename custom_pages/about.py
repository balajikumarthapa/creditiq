...
def show_about():
    ...
    using interpretable machine learning techniques that improve
    ...
    ROC-AUC — a metric that remains reliable on imbalanced data,
    ...
    <li>🎯 Real-Time Prediction Module with SHAP Explainability</li>
    <li>📜 Prediction History Management</li>
    ...
    <li>⚡ Streamlit</li>
    <li>🤖 Scikit-Learn</li>
    <li>🔍 SHAP — Explainable AI Library</li>
    ...
    by integrating SHAP explainability, cross-validation,
